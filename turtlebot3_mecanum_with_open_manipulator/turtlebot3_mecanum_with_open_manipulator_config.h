...
#ifndef TURTLEBOT3_MECANUM_WITH_OPEN_MANIPULATOR_CORE_CONFIG_H_
#define TURTLEBOT3_MECANUM_WITH_OPEN_MANIPULATOR_CORE_CONFIG_H_
...
#include "include/turtlebot3_msgs/SensorState.h"
#include "include/turtlebot3_msgs/Sound.h"
#include "include/turtlebot3_msgs/VersionInfo.h"

#include "src/TurtleBot3.h"
#include "turtlebot3_mecanum_with_open_manipulator.h"
...
float goal_velocity_from_button[3] = {0.0, 0.0, 0.0};
float goal_velocity_from_cmd[3] = {0.0, 0.0, 0.0};
float goal_velocity_from_rc100[3] = {0.0, 0.0, 0.0};
...
#endif // TURTLEBOT3_MECANUM_WITH_OPEN_MANIPULATOR_CORE_CONFIG_H_
