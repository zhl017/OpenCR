...
#include "turtlebot3_mecanum_with_open_manipulator_config.h"
...
{
  static char *joint_states_name[] = {"wheel_left_joint", "wheel_right_joint", "r_wheel_left_joint", "r_wheel_right_joint", "joint1", "joint2", "joint3", "joint4", "gripper"};
