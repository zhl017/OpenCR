...
namespace turtlebot3_msgs
{
  ...
  class SensorState : public ros::Msg
  {
    public:
      ...
      typedef int32_t _r_left_encoder_type;
      _r_left_encoder_type r_left_encoder;
      typedef int32_t _r_right_encoder_type;
      _r_right_encoder_type r_right_encoder;
      ...
      enum { ERROR_R_LEFT_MOTOR =  3 };
      enum { ERROR_R_RIGHT_MOTOR =  4 };
      enum { TORQUE_ON =  1 };
      enum { TORQUE_OFF =  2 };
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_right_encoder.base >> (8 * 3)) & 0xFF;
      ...
      u_r_left_encoder.real = this->r_left_encoder;
      *(outbuffer + offset + 0) = (u_r_left_encoder.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_r_left_encoder.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_r_left_encoder.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_r_left_encoder.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->r_left_encoder);
      union {
        int32_t real;
        uint32_t base;
      } u_r_right_encoder;
      u_r_right_encoder.real = this->r_right_encoder;
      *(outbuffer + offset + 0) = (u_r_right_encoder.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_r_right_encoder.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_r_right_encoder.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_r_right_encoder.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->r_right_encoder);
      union {
        float real;
        uint32_t base;
      } u_battery;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_r_left_encoder.base = 0;
      u_r_left_encoder.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_r_left_encoder.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_r_left_encoder.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_r_left_encoder.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->r_left_encoder = u_r_left_encoder.real;
      offset += sizeof(this->r_left_encoder);
      union {
        int32_t real;
        uint32_t base;
      } u_r_right_encoder;
      u_r_right_encoder.base = 0;
      u_r_right_encoder.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_r_right_encoder.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_r_right_encoder.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_r_right_encoder.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->r_right_encoder = u_r_right_encoder.real;
      offset += sizeof(this->r_right_encoder);
      union {
        float real;
        uint32_t base;
    ...
    const char * getMD5(){ return "7a6e403815226705889843ed862011b3"; };
    // 7a6e403815226705889843ed862011b3
  };
