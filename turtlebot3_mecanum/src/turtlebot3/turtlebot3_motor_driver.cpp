...
bool Turtlebot3MotorDriver::readEncoder(int32_t &left_value, int32_t &right_value, int32_t &r_left_value, int32_t &r_right_value)
{
...
bool Turtlebot3MotorDriver::writeVelocity(int64_t left_value, int64_t right_value, int64_t r_left_value, int64_t r_right_value)
{
...
bool Turtlebot3MotorDriver::controlMotor(const float wheel_radius, const float wheel_separation_x, const float wheel_separation_y, float* value)
{
  bool dxl_comm_result = false;

  float wheel_velocity_cmd[4];
  float lin_vel_x = value[0];
  float lin_vel_y = (-1) * value[1];
  ...
  dxl_comm_result = writeVelocity((int64_t)wheel_velocity_cmd[LEFT], (int64_t)wheel_velocity_cmd[RIGHT], (int64_t)wheel_velocity_cmd[R_LEFT], (int64_t)wheel_velocity_cmd[R_RIGHT]);
