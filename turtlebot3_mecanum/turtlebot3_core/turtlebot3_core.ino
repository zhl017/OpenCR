...
void updateMotorInfo(int32_t left_tick, int32_t right_tick, int32_t r_left_tick, int32_t r_right_tick)
{
  ...
  if (init_encoder)
  {
    ...
    last_tick[LEFT] = r_left_tick;
    last_tick[RIGHT] = r_right_tick;
...
{
  static char *joint_states_name[] = {(char*)"wheel_left_joint", (char*)"wheel_right_joint", (char*)"wheel_r_left_joint", (char*)"wheel_r_right_joint"};
