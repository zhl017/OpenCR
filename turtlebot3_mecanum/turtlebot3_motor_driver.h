...
#define DXL_R_LEFT_ID			3       // ID of rear_left motor
#define DXL_R_RIGHT_ID			4       // ID of rear_right motor
...
class Turtlebot3MotorDriver
{
 public:
  ...
  bool readEncoder4(int32_t &left_value, int32_t &right_value, int32_t &r_left_value, int32_t &r_right_value);
  bool writeVelocity4(int64_t left_value, int64_t right_value, int64_t r_left_value, int64_t r_right_value);
  bool controlMotor_4wheel(const float wheel_radius, const float wheel_separation, float* value);

  bool controlMotor_mecanum(const float wheel_radius, const float wheel_separation_x, const float wheel_separation_y, float* value);
 ...
 private:
  ...
  uint8_t r_left_wheel_id_;
  uint8_t r_right_wheel_id_;
  bool torque_;
